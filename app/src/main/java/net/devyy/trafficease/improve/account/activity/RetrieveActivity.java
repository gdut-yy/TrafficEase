package net.devyy.trafficease.improve.account.activity;
...
import net.devyy.trafficease.improve.utils.parser.RichTextParser;
//import net.devyy.trafficease.util.TDevice;
...
//        SMSSDK.unregisterAllEventHandler();
    ...
    private void isRegister(){
        ...
        easeApi = new RetrofitHelper().getTeApi();
        callback = easeApi.isRegister(phoneNumber);
